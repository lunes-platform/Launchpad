...
/**
 * Interface que define o retorno do hook usePolkadotExtension
 */
 ...
 *
 * @returns {UsePolkadotExtensionReturn} Objeto com estado e funções da extensão
 */
export const usePolkadotExtension = (): UsePolkadotExtensionReturn => {
...
export default usePolkadotExtension;
