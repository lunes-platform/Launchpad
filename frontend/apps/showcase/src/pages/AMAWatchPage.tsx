                          ...
                          >
                            ...
                            <div className="flex items-start gap-3 mb-3">
                              <div className="flex-shrink-0">
                                <img
                                  ...
                                  className="w-8 h-8 rounded-full object-cover ring-2 ring-gray-100 dark:ring-grafite-600"
                                  onError={(e) => {
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1 flex-wrap">
                                  ...
                                  {question.user.isVip && (
                                    <Badge className="bg-gradient-to-r from-purple-500 to-purple-600 text-white text-xs px-2 py-0.5 font-medium">
                                      VIP
                                    </Badge>
                                  )}
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                >
                                  <ThumbsUp className={`w-3.5 h-3.5 ${question.isLiked ? 'fill-current' : ''}`} />
                              ...
                              <div className="flex items-center gap-2">
                                {question.isAnswered && (
                                  <Badge className="bg-gradient-to-r from-green-500 to-green-600 text-white text-xs px-2 py-0.5 font-medium">
                                    ✓ Respondida
                                  </Badge>
                                )}
                                {question.isHighlighted && (
                                  <Badge className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white text-xs px-2 py-0.5 font-medium">
                                    ⭐ Destacada
                                  </Badge>
                                )}
                              </div>
